...
const projects: { name: string, desc: string, details: string, resp: string, appRef: string, gitRef: string, imgRef: any; }[] = [
    {
        name: "Lord of the rings' card decks",
        desc: "Is a LOTR game card deck collector.",
        details: "The app is written with React.js (TypeScript) and Redux for state management.",
        resp: "This project has no back end and is designed to fetch APIs. The development focus was to build an app with best quality standards in mind. The app has small and unit testable components, straightforward and simple data model, and very neat architecture. React testing library is used for testing the app and Github actions is used for continuous integration of this project.",
        appRef: "https://awesome-sinoussi-0a4461.netlify.app/",
        gitRef: "https://github.com/ark13da/LOTR",
        imgRef: LOTR
    },
    {
        name: "Voizy chat",
    ...
    },
    {
        ...
        resp: "This was the coding exercise for fornt-end developer position (Summer job) at HoxHunt. My task was to use the data fetched by GraphQL query and design and render a set of cards to display information about heros.",
    ...
    },
    {
        ...
        appRef: "https://modest-kilby-c28e7d.netlify.app/#/",
    ...
    },
    {
        ...
        details: "The app is written with vinilla javascript, HTML and CSS.",
